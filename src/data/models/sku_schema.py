"""
SKU Index Schema - Redis 8.6 HYBRID Search
Marketplace SKUs index with optimized field weights and hybrid scoring
"""
...
# Field weights for FTS (production-optimized for marketplace)
FIELD_WEIGHTS = {
    "title": 10.0,      # Product name is everything in marketplace
    "brand": 7.0,       # Brand very important for SKUs
    "category": 5.0,    # Category helps filtering
    "description": 2.0, # Description useful
    "tags": 4.0,        # Tags important for discovery
...
def create_index(redis_client: redis.Redis) -> bool:
    """Create SKUs index with HYBRID search support"""
    try:
